...
namespace Demo.ui.view.snippet
{
    ...
    /// </summary>
    public partial class BPGreen : UserControl
    {
        public BPGreen()
        {
            InitializeComponent();
        ...
        public static DependencyProperty MyPropertyProperty0 =
            DependencyProperty.Register("MyProperty0", typeof(string), typeof(BPGreen), new PropertyMetadata(""));
        ...
        public static DependencyProperty MyPropertyProperty1 =
            DependencyProperty.Register("MyProperty1", typeof(string), typeof(BPGreen), new PropertyMetadata(""));
