...
namespace Demo.ui.view.snippet
{
    ...
    /// </summary>
    public partial class BPGreen3 : UserControl
    {
        public BPGreen3()
        {
            InitializeComponent();
        ...
        public static DependencyProperty MyPropertyProperty0 =
            DependencyProperty.Register("MyProperty0", typeof(string), typeof(BPGreen3), new PropertyMetadata(""));
        ...
        //    DependencyProperty.Register("MyProperty1", typeof(string), typeof(BPGreen3), new PropertyMetadata(""));
